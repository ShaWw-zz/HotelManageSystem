...
public class Photo1 {
    ...
    public  static void start() throws Exception {
        ...
        borderPane.setStyle("-fx-background-image: url(images/paizhao1.png); -fx-background-repeat: no-repeat;-fx-background-size: 800 600; -fx-background-position: center center;");
