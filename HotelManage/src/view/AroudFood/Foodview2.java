...
public class Foodview2 {
    ...
    public  static void start() throws Exception {
        ...
        borderPane.setStyle("-fx-background-image: url(images/food2.jpg); -fx-background-repeat: no-repeat;-fx-background-size: 800 600; -fx-background-position: center center;");
